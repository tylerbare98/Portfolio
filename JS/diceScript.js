...
document.getElementById("btnListener").addEventListener("click", rollDice1);
document.getElementById("btnListener").addEventListener("click", rollDice2);
document.getElementById("btnListener").addEventListener("click", rollDice3);
